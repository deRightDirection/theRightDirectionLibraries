namespace theRightDirection.Networking.Process.SystemHttp.Json
{
    ...
    /// <summary>
    /// Defines a network process for a POST with a JSON response.
    /// </summary>
    public sealed class PostJsonNetworkProcess : NetworkProcess
    {
        private readonly HttpClient client;

        /// <summary>
        /// Initializes a new instance of the <see cref="PostJsonNetworkProcess"/> class.
        /// </summary>
        /// <param name="client">
        /// The <see cref="HttpClient"/>.
        /// </param>
        public PostJsonNetworkProcess(HttpClient client)
        ...
        /// </param>
        public PostJsonNetworkProcess(HttpClient client, string queueId)
        ...
        {
            if (this.client == null) throw new InvalidOperationException("No HTTP client has been supplied for the PostJsonNetworkProcess.");
        ...
        {
            if (this.client == null) throw new InvalidOperationException("No HTTP client has been supplied for the PostJsonNetworkProcess.");
            if (string.IsNullOrWhiteSpace(this.Url)) throw new InvalidOperationException("No URL has been supplied for the PostJsonNetworkProcess.");
