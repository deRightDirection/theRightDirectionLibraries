...
using theRightDirection.Enumerations;
...
namespace theRightDirection
{
    ...
    public static partial class Extensions
    {
        ...
        /// </param>
        /// <returns>Returns the start day of the week <see cref="DateTime"/>.</returns>
        ...
        /// </param>
        /// <returns>Returns the suffix of the specified day as a <see cref="string"/>.</returns>
        ...
        /// </summary>
        /// <param name="dateTime">The <see cref="DateTime"/> to compare.</param>
        /// <returns>Returns the age as an <see cref="int"/>.</returns>
        ...
        /// </summary>
        /// <param name="dateTime">The <see cref="DateTime"/> to get the state of day.</param>
        /// <returns>
        ...
        /// <param name="minDate">The <see cref="DateTime"/> to compare less than.</param>
        /// <returns>
        /// Returns true if the specified <see cref="DateTime"/> is less than the <see
        /// cref="DateTime"/>; else false.
        /// </returns>
        ...
        /// </summary>
        /// <param name="dateTime">The <see cref="DateTime"/>.</param>
        /// <param name="maxDate">The <see cref="DateTime"/> to compare greater than.</param>
        /// <returns>
        /// Returns true if the specified <see cref="DateTime"/> is greater than the <see
        /// cref="DateTime"/>; else false.
        /// </returns>
        ...
        /// <summary>
        /// returns a datetime offset in case the datetime is before the lower value of a datetime
        /// or after the maximum value
        /// </summary>
        /// <param name="dateTime"></param>
        /// <returns></returns>
